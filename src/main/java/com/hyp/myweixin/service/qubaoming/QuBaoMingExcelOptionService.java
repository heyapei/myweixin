 ...
 * @Description: TODO
 */
public interface QuBaoMingExcelOptionService {
     ...
     */
    List<SignUpExcelExportVO> exportSignUpExcelExportVOByActiveId(Integer activeId) throws MyDefinitionException;
